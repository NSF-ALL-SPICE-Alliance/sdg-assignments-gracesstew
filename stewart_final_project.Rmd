...
We will make a variable called "normalized_score_sdg6" containing only these indicators/scores.
```{r}
...
We will be viewing SDG 6's normalized scores for the indicator Water, Sanitation, and Scarce Water, because I feel they are the most general and relevant indicators that anyone would be able to easily understand.
...
We see that "normalized_score_sdg12_nimport" is water scarcity's most important prediction variable. This is SDG 12 indicator Material Footprint. This refers to the total amount of materials used in an economy. This is important to water scarcity as it gives insight to whether or not resources are being consumed and used effectively.It is shown to trend positively in our second graph at a "normalized_score_sdg12_nimport" score of 10 This is likely because with basic, responsible consumption of resources, water scarcity is being preserved. With the help of SDG indicator 12.2.1, promotion of responsible and sustainable consumption can help achieve this indicator.
